...
const SignUp = () => {
  return (
    <div className="min-h-screen w-full flex flex-col items-center">
      <div className="max-w-[389px] min-h-screen w-full items-center text-sm bg-blackPrimary pt-16 px-7">
        ...
        <h1 className="text-4xl font-bold text-center mt-2 mb-10 text-yellowPrimary">
          Sign up
        </h1>
